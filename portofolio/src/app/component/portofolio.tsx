...
const accounts = [
  {
    name: "GitHub",
    icon: Github,
    url: "https://github.com/manish5476/",
    bg: "bg-gray-800",
  },
  {
    name: "LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/manish-singh-345a2623b/",
    bg: "bg-blue-700",
  },
  {
    name: "LeetCode",
    icon: Code,
    url: "https://leetcode.com/u/msms5476/",
    bg: "bg-gray-600",
  },
  // {
  //   name: "Coding Ninjas",
  ...
  // },
  {
    name: "Instagram",
    icon: Instagram,
    url: "https://www.instagram.com/manish_singh_2712/",
    bg: "bg-green-700",
  },

  {
    name: "X",
    icon: Twitter,
    url: "https://x.com/ManishSingh_299",
    bg: "bg-gray-700",
  },
];
...
const projects = [
  {
    title: "React based Employee management system",
    description:
      "A real-time Management app with Live Work Update and attandence managaement.",
...
export default function StylishPortfolio() {
  ...
  const handleSubmit = (e: any) => {
    ...
    // Create FormData object to match Google Form fields
    const googleForm = new FormData();
    googleForm.append("entry.1178976162", formData.name); // Name
    googleForm.append("entry.2022748946", formData.email); // Email
    googleForm.append("entry.445978353", formData.message); // Message

    // Submit the form to Google Forms
    fetch(
      "https://docs.google.com/forms/d/e/1FAIpQLSc_HaFpJuSHkj24jEnmtEpUr4AsktxhGZ66bOe5GdpYhVkW0w/formResponse",
      {
        method: "POST",
        body: googleForm,
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="md:w-1/2 md:pl-10">
                ...
                >
                  As a passionate Computer Engineering student, I'm on a mission
                  to push the boundaries of technology. My journey in the world
                  of coding began with a simple "Hello, World!" and has evolved
                  into a relentless pursuit of innovation in AI and web
                  technologies.
                </motion.p>
                <motion.p
                ...
                >
                  ...
                  projects, or mentoring aspiring developers. My goal is to
                  create solutions that not only solve complex problems but also
                  inspire and empower others in the tech community.
                </motion.p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
              {skills.map((skill, index) => (
                ...
                >
                  <div className={`${skill.color} flex flex-col items-center`}>
                    {skill.icon}
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                      ...
                      <p>Email: manish.singh.nehal@gmail.com</p>
                      <p>Phone: (+91) 8160966299</p>
